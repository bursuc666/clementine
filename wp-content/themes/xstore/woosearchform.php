...
<?php if(class_exists('Woocommerce')) : ?>
	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" id="searchform" class="<?php echo esc_attr($class); ?>" method="get">
		<div class="input-row">
			...
			<?php endif ?>
			<?php wp_dropdown_categories(array( 'show_option_all' => esc_html__( 'All categories', 'xstore' ) ,'taxonomy' => $ajax['taxonomy'], 'hierarchical' => true, 'name' => $ajax['name'], 'value_field' => 'slug')) ?>
